...
def dataTableStats(data, dataIDs, columnList):
    ...
    for sampleID in [int(sampleID) for sampleID in data['SampleID'].unique() if sampleID >= 0]:
...
def obsTableStatsBootstrap(observations):
    ...
    for sampleID in [int(sampleID) for sampleID in observations['SampleID'].unique() if sampleID >= 0]:
...
timeData = [round(sampleID * .002,4) for sampleID in bootstrapDataStatsControl['SampleID'].unique() if sampleID >= 0]
timeObs = [round(sampleID * .002,4) for sampleID in bootstrapObsStatsControl['SampleID'].unique() if sampleID >= 0]
...
timeData = [round(sampleID * .002,4) for sampleID in bootstrapDataStatsMass['SampleID'].unique() if sampleID >= 0]
timeObs = [round(sampleID * .002,4) for sampleID in bootstrapObsStatsMass['SampleID'].unique() if sampleID >= 0]
...
timeData = [round(sampleID * .002,4) for sampleID in bootstrapDataStatsInertia['SampleID'].unique() if sampleID >= 0]
timeObs = [round(sampleID * .002,4) for sampleID in bootstrapObsStatsInertia['SampleID'].unique() if sampleID >= 0]
...
timeObsControl = [round(sampleID * .002,4) for sampleID in bootstrapObsStatsControl['SampleID'].unique() if sampleID >= 0]

timeObsMass = [round(sampleID * .002,4) for sampleID in bootstrapObsStatsMass['SampleID'].unique() if sampleID >= 0]

timeObsInertia = [round(sampleID * .002,4) for sampleID in bootstrapObsStatsInertia['SampleID'].unique() if sampleID >= 0]
...
timeDataControl = [round(sampleID * .002,4) for sampleID in bootstrapDataStatsControl['SampleID'].unique() if sampleID >= 0]

timeDataMass = [round(sampleID * .002,4) for sampleID in bootstrapDataStatsMass['SampleID'].unique() if sampleID >= 0]

timeDataInertia = [round(sampleID * .002,4) for sampleID in bootstrapDataStatsInertia['SampleID'].unique() if sampleID >= 0]
...
dataLegendC, = plt.plot(timeDataControl.pop(0),np.diff(np.diff(bootstrapDataStatsControl['x'])),'b',linewidth=2.0,label='Roach_Control_Mean')
dataLegendSC, = plt.plot(timeDataControl.pop(0),np.diff(np.diff(bootstrapDataStatsControl['x_01'])),'b--',label='Roach_Control_95%')
plt.plot(timeDataControl.pop(0),np.diff(np.diff(bootstrapDataStatsControl['x_99'])),'b--',label='Roach_95%')

dataLegendM, = plt.plot(timeDataMass.pop(0),np.diff(np.diff(bootstrapDataStatsMass['x'])),'r',linewidth=2.0,label='Roach_Mass_Mean')
dataLegendSM, = plt.plot(timeDataMass.pop(0),np.diff(np.diff(bootstrapDataStatsMass['x_01'])),'r--',label='Roach_Mass_95%')
plt.plot(timeDataMass.pop(0),np.diff(np.diff(bootstrapDataStatsMass['x_99'])),'r--',label='Roach_95%')

dataLegendI, = plt.plot(timeDataInertia.pop(0),np.diff(np.diff(bootstrapDataStatsInertia['x'])),'g',linewidth=2.0,label='Roach_Inertia_Mean')
dataLegendSI, = plt.plot(timeDataInertia.pop(0),np.diff(np.diff(bootstrapDataStatsInertia['x_01'])),'g--',label='Roach_Inertia_95%')
plt.plot(timeDataInertia.pop(0),np.diff(np.diff(bootstrapDataStatsInertia['x_99'])),'g--',label='Roach_95%')
